        ...
        listpuasa.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0){
                    ...
                    Intent puasadibulanSyaban = new Intent(MainActivity.this, Detail.class);
                    puasadibulanSyaban.putExtra("posisi", position);
                    puasadibulanSyaban.putExtra("link", "https://muslim.or.id/15917-anjuran-puasa-syaban.html");
                    startActivity(puasadibulanSyaban);
                }else if (position == 5){
